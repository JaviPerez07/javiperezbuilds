...
(() => {
  ...
  const T = {
    en: {
      ...
      // ===== Hero =====
      hero_hook: 'Skills for Claude Code & Codex — sold as commands: /javiperez-*',
      hero_h1_w1: 'Skills that find',
      hero_h1_w2: "what's broken.",
      hero_h1_w3: 'And tell you',
      hero_h1_w4: 'how to',
      hero_h1_w5: 'charge for it.',
      hero_h1_aria: "Skills that find what's broken. And tell you how to charge for it.",
      hero_sub: "Skills for Claude Code and Codex with one method: measure, prove, treat. Websites, algorithmic trading — whatever's next. You type /javiperez-*, you get the report that closes the sale or saves your account.",
      ...
      hero_counter_buyers: 'traders & builders',
      hero_counter_buyers2: 'already use my skills',
      hero_counter_skills: 'skills built',
      hero_counter_skills2: 'and selling',
      hero_counter_tests: 'tests green',
      hero_counter_tests2: 'before every sale',
      hero_counter_pack: 'pack: sold in hours',
      hero_counter_pack2: 'with a single video',
      hero_cta_primary: 'See the skills →',
      hero_cta_secondary: 'Work for hire →',
      hero_featured: 'Featured in',
      hero_term_micro: 'The command carries my name. The report carries your sale.',
      hero_scroll: 'Scroll',
      ...
      // ===== Services =====
      skills_kicker: 'The skills',
      skills_h2_pre: 'Two packs. One method: ',
      skills_h2_accent: 'diagnose, then treat.',
      skills_sub: 'Forensic skills for Claude Code & Codex. Measured findings, applicable fixes, zero invented numbers.',
      skills_p1_title: 'Web Forensics Pack',
      skills_p1_desc: '5 skills: forensic diagnosis (webblood) + treatments for local SEO, speed, business identity and reviews. Built for sites that need to convert.',
      skills_p1_badge: 'Founder launch',
      skills_p1_cta: 'See the pack →',
      skills_p2_title: 'El Polígrafo',
      skills_p2_desc: 'The lie detector for your algorithmic trading: 15 forensic skills in 3 packs. Your backtest is lying — El Polígrafo proves it.',
      skills_p2_badge: 'Founder launch',
      skills_p2_cta: 'See the pack →',
      srv_kicker: 'For hire',
      srv_h2_pre: 'I also take ',
      srv_h2_accent: 'client work.',
      srv_sub: 'Productized engagements with clear scope, timeline, and price — from AdSense-ready websites to AI workflow automation, plus websites for local businesses. No project bloat.',
      srv_price: 'Price',
      ...
      local_recent1_tag: 'Leo Cano Íntimo · Roquetas de Mar',
      local_recent1_desc: 'First website in 32 years · new customers walking in from week one',
      ...
      about_p1_html: "I'm 20 years old, based in Spain. I build production AI systems and websites with <strong>Claude Code</strong> as my daily driver.",
    ...
    es: {
      ...
      // ===== Hero =====
      hero_hook: 'Skills para Claude Code y Codex — vendidas como comandos: /javiperez-*',
      hero_h1_w1: 'Skills que encuentran',
      hero_h1_w2: 'lo que está roto.',
      hero_h1_w3: 'Y te dicen',
      hero_h1_w4: 'cómo',
      hero_h1_w5: 'cobrarlo.',
      hero_h1_aria: 'Skills que encuentran lo que está roto. Y te dicen cómo cobrarlo.',
      hero_sub: 'Skills para Claude Code y Codex con un método: medir, demostrar, tratar. Webs, trading algorítmico — lo próximo. Tecleas /javiperez-*, obtienes el informe que cierra la venta o salva tu cuenta.',
      ...
      hero_counter_buyers: 'traders y builders',
      hero_counter_buyers2: 'ya usan mis skills',
      hero_counter_skills: 'skills construidas',
      hero_counter_skills2: 'y vendiéndose',
      hero_counter_tests: 'tests en verde',
      hero_counter_tests2: 'antes de cada venta',
      hero_counter_pack: 'pack: vendido en horas',
      hero_counter_pack2: 'con un solo vídeo',
      hero_cta_primary: 'Ver las skills →',
      hero_cta_secondary: 'Trabajo por encargo →',
      hero_featured: 'Aparecido en',
      hero_term_micro: 'El comando lleva mi nombre. El informe lleva tu venta.',
      hero_scroll: 'Scroll',
      ...
      // ===== Services =====
      skills_kicker: 'Las skills',
      skills_h2_pre: 'Dos packs. Un método: ',
      skills_h2_accent: 'diagnosticar y tratar.',
      skills_sub: 'Skills forenses para Claude Code y Codex. Hallazgos medidos, arreglos aplicables, cero cifras inventadas.',
      skills_p1_title: 'Pack Web Forense',
      skills_p1_desc: '5 skills: diagnóstico forense (webblood) + tratamientos de SEO local, velocidad, identidad de negocio y reseñas. Para webs que tienen que convertir.',
      skills_p1_badge: 'Lanzamiento fundador',
      skills_p1_cta: 'Ver el pack →',
      skills_p2_title: 'El Polígrafo',
      skills_p2_desc: 'El detector de mentiras de tu trading algorítmico: 15 skills forenses en 3 packs. Tu backtest miente — El Polígrafo lo demuestra.',
      skills_p2_badge: 'Lanzamiento fundador',
      skills_p2_cta: 'Ver el pack →',
      srv_kicker: 'Por encargo',
      srv_h2_pre: 'También trabajo por ',
      srv_h2_accent: 'encargo.',
      srv_sub: 'Engagements productizados con scope, plazo y precio cerrados — desde webs AdSense-ready hasta automatización con IA, incluyendo webs para negocios locales. Sin project bloat.',
      srv_price: 'Precio',
      srv_timeline: 'Plazo',
      ...
      local_recent1_tag: 'Leo Cano Íntimo · Roquetas de Mar',
      local_recent1_desc: 'Primera web en 32 años · clientes nuevos desde la primera semana',
      ...
      about_h2_accent: 'Javi.',
      about_p1_html: 'Tengo 20 años, vivo en España. Construyo sistemas de IA en producción y webs con <strong>Claude Code</strong> como mi daily driver.',
