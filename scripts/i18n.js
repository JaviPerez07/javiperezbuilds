...
(() => {
  ...
  const T = {
    en: {
      // ===== Home rediseñada (Claude Design) — EN pendiente de traducir =====
      nh_nav_skills: "[PENDIENTE_EN]",
      nh_nav_serv: "[PENDIENTE_EN]",
      nh_nav_cta: "[PENDIENTE_EN]",
      nh_hero_eyebrow: "[PENDIENTE_EN]",
      nh_hero_h1: "[PENDIENTE_EN]",
      nh_hero_sub: "[PENDIENTE_EN]",
      nh_d1_label: "[PENDIENTE_EN]",
      nh_d1_title: "[PENDIENTE_EN]",
      nh_d1_desc: "[PENDIENTE_EN]",
      nh_d1_cta: "[PENDIENTE_EN]",
      nh_d2_label: "[PENDIENTE_EN]",
      nh_d2_title: "[PENDIENTE_EN]",
      nh_d2_desc: "[PENDIENTE_EN]",
      nh_d2_cta: "[PENDIENTE_EN]",
      nh_serv_eyebrow: "[PENDIENTE_EN]",
      nh_serv_h2: "[PENDIENTE_EN]",
      nh_serv_p: "[PENDIENTE_EN]",
      nh_serv_pill: "[PENDIENTE_EN]",
      nh_vid_eyebrow: "[PENDIENTE_EN]",
      nh_vid_h3: "[PENDIENTE_EN]",
      nh_vid_p: "[PENDIENTE_EN]",
      nh_vid_time: "[PENDIENTE_EN]",
      nh_vid_cta: "[PENDIENTE_EN]",
      nh_s1_title: "[PENDIENTE_EN]",
      nh_s1_desc: "[PENDIENTE_EN]",
      nh_lbl_precio: "[PENDIENTE_EN]",
      nh_lbl_plazo: "[PENDIENTE_EN]",
      nh_s1_time: "[PENDIENTE_EN]",
      nh_card_cta: "[PENDIENTE_EN]",
      nh_s2_title: "[PENDIENTE_EN]",
      nh_s2_desc: "[PENDIENTE_EN]",
      nh_s2_time: "[PENDIENTE_EN]",
      nh_s3_title: "[PENDIENTE_EN]",
      nh_s3_desc: "[PENDIENTE_EN]",
      nh_s3_time: "[PENDIENTE_EN]",
      nh_skills_eyebrow: "[PENDIENTE_EN]",
      nh_skills_h2: "[PENDIENTE_EN]",
      nh_skills_p: "[PENDIENTE_EN]",
      nh_pwf_label: "[PENDIENTE_EN]",
      nh_pwf_h3: "[PENDIENTE_EN]",
      nh_pwf_sub: "[PENDIENTE_EN]",
      nh_pwf_cta1: "[PENDIENTE_EN]",
      nh_pwf_skills_label: "[PENDIENTE_EN]",
      nh_pwf_sk1: "[PENDIENTE_EN]",
      nh_pwf_sk2: "[PENDIENTE_EN]",
      nh_pwf_sk3: "[PENDIENTE_EN]",
      nh_pwf_sk4: "[PENDIENTE_EN]",
      nh_pwf_sk5: "[PENDIENTE_EN]",
      nh_output_label: "[PENDIENTE_EN]",
      nh_pwf_anchor: "[PENDIENTE_EN]",
      nh_pwf_market: "[PENDIENTE_EN]",
      nh_pwf_cta2: "[PENDIENTE_EN]",
      nh_pol_label: "[PENDIENTE_EN]",
      nh_pol_h3: "[PENDIENTE_EN]",
      nh_pol_sub: "[PENDIENTE_EN]",
      nh_pol_cta1: "[PENDIENTE_EN]",
      nh_pol_detect_label: "[PENDIENTE_EN]",
      nh_pol_i1: "[PENDIENTE_EN]",
      nh_pol_i2: "[PENDIENTE_EN]",
      nh_pol_i3: "[PENDIENTE_EN]",
      nh_pol_i4: "[PENDIENTE_EN]",
      nh_pol_disc: "[PENDIENTE_EN]",
      nh_pol_anchor: "[PENDIENTE_EN]",
      nh_pol_badge: "[PENDIENTE_EN]",
      nh_pol_pricedetail: "[PENDIENTE_EN]",
      nh_pol_cta2: "[PENDIENTE_EN]",
      nh_custom_label: "[PENDIENTE_EN]",
      nh_custom_h3: "[PENDIENTE_EN]",
      nh_custom_p: "[PENDIENTE_EN]",
      nh_custom_note: "[PENDIENTE_EN]",
      nh_custom_cta: "[PENDIENTE_EN]",
      nh_proof_eyebrow: "[PENDIENTE_EN]",
      nh_proof_h2: "[PENDIENTE_EN]",
      nh_proof_p: "[PENDIENTE_EN]",
      nh_pay_label: "[PENDIENTE_EN]",
      nh_pay_h3: "[PENDIENTE_EN]",
      nh_pay_p: "[PENDIENTE_EN]",
      nh_offer_label: "[PENDIENTE_EN]",
      nh_offer_h3: "[PENDIENTE_EN]",
      nh_offer_p: "[PENDIENTE_EN]",
      nh_offer_cta: "[PENDIENTE_EN]",
      nh_contact_eyebrow: "[PENDIENTE_EN]",
      nh_contact_h2: "[PENDIENTE_EN]",
      nh_contact_p: "[PENDIENTE_EN]",
      nh_contact_cta: "[PENDIENTE_EN]",
      nh_foot_links: "[PENDIENTE_EN]",
      nh_foot_legal: "[PENDIENTE_EN]",
      nh_foot_priv: "[PENDIENTE_EN]",
      nh_foot_cookies: "[PENDIENTE_EN]",
      nh_foot_status: "[PENDIENTE_EN]",
      // ===== Top urgency strip =====
    ...
    es: {
      // ===== Home rediseñada (Claude Design) =====
      nh_nav_skills: "Agentes",
      nh_nav_serv: "Servicios",
      nh_nav_cta: "Hablamos",
      nh_hero_eyebrow: "Construyo con IA · Almería, España",
      nh_hero_h1: "Agentes de IA que hacen <em style=\"color:#D97757;font-style:italic;font-weight:500\">un trabajo concreto</em>. Tú ganas tiempo.",
      nh_hero_sub: "Agentes listos para usar y webs/sistemas a medida. Tú eliges la puerta; yo te enseño la evidencia.",
      nh_d1_label: "Puerta 01 — Producto",
      nh_d1_title: "Quiero <span style=\"color:#D97757\">agentes</span> de IA",
      nh_d1_desc: "Agentes listos para usar: auditoría web forense y diagnóstico de trading. Compra, descarga, ejecuta.",
      nh_d1_cta: "Ver los agentes",
      nh_d2_label: "Puerta 02 — Servicio",
      nh_d2_title: "Quiero que me <span style=\"color:#D97757\">construyas</span> algo",
      nh_d2_desc: "Webs que venden, funnels y sistemas con IA. Precio y plazo cerrados por adelantado.",
      nh_d2_cta: "Ver servicios",
      nh_serv_eyebrow: "Servicios — lo que construyo",
      nh_serv_h2: "Te lo construyo yo. <em style=\"color:#D97757;font-style:italic;font-weight:500\">Precio y plazo cerrados.</em>",
      nh_serv_p: "Las agencias cobran bastante más por trabajos equivalentes. Aquí el alcance, el precio y el plazo están cerrados por adelantado. Haz tú la cuenta.",
      nh_serv_pill: "Dato de mercado [INFERIDO] · sin promesas de resultado",
      nh_vid_eyebrow: "Web con fondo legendario / animada",
      nh_vid_h3: "Un hero <em style=\"color:#D97757;font-style:italic;font-weight:500\">cinematográfico</em> que se queda en la memoria.",
      nh_vid_p: "Vídeo en bucle a pantalla completa, degradado para legibilidad y micro-animaciones de scroll. La primera impresión que tu competencia no tiene.",
      nh_vid_time: "7–14 días",
      nh_vid_cta: "La quiero para mi negocio",
      nh_s1_title: "Web para tu negocio local",
      nh_s1_desc: "Landing que vende: estructura de conversión, copy y SEO local de base.",
      nh_lbl_precio: "Precio",
      nh_lbl_plazo: "Plazo",
      nh_s1_time: "5–10 días",
      nh_card_cta: "Hablamos",
      nh_s2_title: "Funnel de ventas local",
      nh_s2_desc: "Captación + cualificación de leads conectada a tus herramientas.",
      nh_s2_time: "7–14 días",
      nh_s3_title: "AI Site Deploy",
      nh_s3_desc: "De tu build de Claude/Lovable a producción: dominio, SSL, analítica.",
      nh_s3_time: "48–72h",
      nh_skills_eyebrow: "Agentes de IA",
      nh_skills_h2: "Agentes listos para usar. <em style=\"color:#D97757;font-style:italic;font-weight:500\">Compra, descarga, ejecuta.</em>",
      nh_skills_p: "Sin mensualidad. Método: medir → demostrar → tratar. Cada dato lleva su etiqueta MEDIDO / INFERIDO. Cero cifras inventadas.",
      nh_pwf_label: "Pack Web Forense · 5 agentes",
      nh_pwf_h3: "Audita cualquier web en 8 módulos y sabe <em style=\"color:#D97757;font-style:italic;font-weight:500\">exactamente</em> qué arreglar.",
      nh_pwf_sub: "Puntúa /100 y mapea cada fallo al agente que lo trata. Etiquetas MEDIDO / INFERIDO. Cero datos inventados.",
      nh_pwf_cta1: "Llevarme el pack — 39,99€",
      nh_pwf_skills_label: "Los 5 agentes del pack",
      nh_pwf_sk1: "<strong style=\"color:#F4F2EC;font-weight:500\">Auditor web</strong> <span style=\"font-family:'JetBrains Mono',monospace;color:#D97757\">(webblood)</span> — analiza 8 áreas de tu web y mapea cada fallo a su tratamiento.",
      nh_pwf_sk2: "<strong style=\"color:#F4F2EC;font-weight:500\">Agente de SEO local</strong> <span style=\"font-family:'JetBrains Mono',monospace;color:#D97757\">(seolocal)</span> — schema LocalBusiness, title/meta, NAP y sitemap listos para aplicar.",
      nh_pwf_sk3: "<strong style=\"color:#F4F2EC;font-weight:500\">Agente de rendimiento</strong> <span style=\"font-family:'JetBrains Mono',monospace;color:#D97757\">(speed)</span> — plan por causa con snippets reales (.htaccess, Nginx, Cloudflare).",
      nh_pwf_sk4: "<strong style=\"color:#F4F2EC;font-weight:500\">Agente de reseñas</strong> <span style=\"font-family:'JetBrains Mono',monospace;color:#D97757\">(reviews)</span> — capta reseñas reales y genera schema Review solo con datos reales.",
      nh_pwf_sk5: "<strong style=\"color:#F4F2EC;font-weight:500\">Agente de identidad de negocio</strong> <span style=\"font-family:'JetBrains Mono',monospace;color:#D97757\">(businessdna)</span> — extrae el ADN del negocio para alimentar al resto.",
      nh_output_label: "Output real (anonimizado)",
      nh_pwf_anchor: "64,95€ sueltas",
      nh_pwf_market: "Un agente suelto: <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">12,99€</span>. <span style=\"color:#6E7890\">[INFERIDO]</span> Las agencias cobran <strong style=\"color:#F4F2EC;font-weight:500\">300–800€</strong> por una auditoría así — echa tú la cuenta. <span style=\"color:#6E7890\">No es promesa de resultado.</span>",
      nh_pwf_cta2: "Quiero el Pack Web Forense",
      nh_pol_label: "El Polígrafo · 15 agentes de trading",
      nh_pol_h3: "Detecta si tu backtest <em style=\"color:#D97757;font-style:italic;font-weight:500\">miente.</em>",
      nh_pol_sub: "Overfitting, martingala oculta, falsa diversificación, edge muerto. Informe forense con evidencia concreta de cada fallo.",
      nh_pol_cta1: "Llevarme el bundle — 99€",
      nh_pol_detect_label: "Qué detecta",
      nh_pol_i1: "<strong style=\"color:#F4F2EC;font-weight:500\">Overfitting</strong> — la estrategia memoriza el pasado, no generaliza.",
      nh_pol_i2: "<strong style=\"color:#F4F2EC;font-weight:500\">Martingala oculta</strong> — riesgo enmascarado que revienta la cuenta.",
      nh_pol_i3: "<strong style=\"color:#F4F2EC;font-weight:500\">Falsa diversificación</strong> — activos correlacionados disfrazados.",
      nh_pol_i4: "<strong style=\"color:#F4F2EC;font-weight:500\">Edge muerto</strong> — ventaja estadística que ya no existe.",
      nh_pol_disc: "No da señales ni promesas de rentabilidad. Es diagnóstico, no asesoría.",
      nh_pol_anchor: "194,85€ sueltas",
      nh_pol_badge: "bundle 15",
      nh_pol_pricedetail: "Agente suelto <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">12,99€</span> · pack de 5 <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">39,99€</span> · bundle 15 <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">99€</span> <span style=\"color:#6E7890\">(los 3 packs sueltos: 119,97€)</span>.",
      nh_pol_cta2: "Quiero El Polígrafo",
      nh_custom_label: "Agente a medida · bajo demanda",
      nh_custom_h3: "¿Necesitas un agente para <em style=\"color:#D97757;font-style:italic;font-weight:500\">tu</em> trabajo concreto?",
      nh_custom_p: "Cuéntame a qué te dedicas y qué tarea repetitiva te come tiempo. Te digo sin rodeos si te lo puedo construir — y si no, también te lo digo. Cada caso es distinto, así que no hay tarifa fija: el precio lo cerramos por privado.",
      nh_custom_note: "No es un catálogo de agentes que no existen: es un encargo. Solo construyo lo que puedo demostrar con código.",
      nh_custom_cta: "Cuéntame tu caso",
      nh_proof_eyebrow: "Prueba real",
      nh_proof_h2: "Esto no es teoría. <em style=\"color:#D97757;font-style:italic;font-weight:500\">Es lo que dicen mis clientes.</em>",
      nh_proof_p: "Mensajes reales de clientes (anonimizados) y cobros reales. La prueba, no el discurso.",
      nh_pay_label: "Pagos reales",
      nh_pay_h3: "Pagos reales, <em style=\"color:#D97757;font-style:italic;font-weight:500\">no promesas.</em>",
      nh_pay_p: "Cobros reales por agentes y servicios. La prueba, no el discurso. <span style=\"color:#6E7890\">Importes y fechas reales; datos de cliente pixelados.</span>",
      nh_offer_label: "Precio de lanzamiento",
      nh_offer_h3: "El bundle a 99€ hasta el <span id=\"deadline-str\" style=\"color:#D97757\">15 de julio</span>.",
      nh_offer_p: "Fecha real, no contador falso. Después sube a su precio de catálogo. <span style=\"color:#6E7890\">Edita la fecha en scripts/home.js.</span>",
      nh_offer_cta: "Aprovechar el lanzamiento",
      nh_contact_eyebrow: "¿Hablamos?",
      nh_contact_h2: "Cuéntame qué necesitas. <em style=\"color:#D97757;font-style:italic;font-weight:500\">Respondo en 24h.</em>",
      nh_contact_p: "Async, sin reuniones de descubrimiento. Me lo describes por escrito y te digo precio y plazo.",
      nh_contact_cta: "Escríbeme por WhatsApp",
      nh_foot_links: "Links",
      nh_foot_legal: "Aviso legal",
      nh_foot_priv: "Privacidad",
      nh_foot_cookies: "Cookies",
      nh_foot_status: "Almería, España · Working async",
      // ===== Top urgency strip =====
