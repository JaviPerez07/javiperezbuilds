...
(() => {
  ...
  const T = {
    ...
    es: {
      ...
      nh_nav_skills: "Skills",
      nh_nav_serv: "Servicios",
      nh_nav_cta: "Hablamos",
      nh_hero_eyebrow: "Construyo con IA · Almería, España",
      nh_hero_h1: "Resuelvo problemas reales de negocio — con <em style=\"color:#D97757;font-style:italic;font-weight:500\">IA</em> y código.",
      nh_hero_sub: "Skills de Claude listas para usar y webs/sistemas a medida. Tú eliges la puerta; yo te enseño la evidencia.",
      nh_d1_label: "Puerta 01 — Producto",
      nh_d1_title: "Quiero <span style=\"color:#D97757\">skills</span> de Claude",
      nh_d1_desc: "Packs listos para usar: auditoría web forense y diagnóstico de trading. Compra, descarga, ejecuta.",
      nh_d1_cta: "Ver las skills",
      ...
      nh_s3_time: "48–72h",
      nh_skills_eyebrow: "Skills de Claude",
      nh_skills_h2: "Skills listas para usar. <em style=\"color:#D97757;font-style:italic;font-weight:500\">Compra, descarga, ejecuta.</em>",
      ...
      nh_pwf_label: "Pack Web Forense · 5 skills",
      ...
      nh_pwf_sub: "Puntúa /100 y mapea cada fallo a la skill que lo trata. Etiquetas MEDIDO / INFERIDO. Cero datos inventados.",
      nh_pwf_cta1: "Llevarme el pack — 39,99€",
      nh_pwf_skills_label: "Las 5 skills del pack",
      nh_pwf_sk1: "Audita en 8 módulos, puntúa /100 y mapea cada fallo a su tratamiento.",
      nh_pwf_sk2: "SEO local: schema LocalBusiness, title/meta, NAP, sitemap.",
      nh_pwf_sk3: "Plan de rendimiento por causa, con snippets reales (.htaccess, Nginx, Cloudflare).",
      nh_pwf_sk4: "Captación de reseñas reales + schema Review (solo con datos reales).",
      nh_pwf_sk5: "Extrae la identidad del negocio para alimentar a las demás.",
      nh_output_label: "Output real (anonimizado)",
      nh_pwf_anchor: "64,95€ sueltas",
      nh_pwf_market: "Una skill suelta: <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">12,99€</span>. <span style=\"color:#6E7890\">[INFERIDO]</span> Las agencias cobran <strong style=\"color:#F4F2EC;font-weight:500\">300–800€</strong> por una auditoría así — echa tú la cuenta. <span style=\"color:#6E7890\">No es promesa de resultado.</span>",
      nh_pwf_cta2: "Quiero el Pack Web Forense",
      nh_pol_label: "El Polígrafo · 15 skills de trading",
      ...
      nh_pol_pricedetail: "Skill suelta <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">12,99€</span> · pack de 5 <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">39,99€</span> · bundle 15 <span style=\"font-family:'JetBrains Mono',monospace;color:#F4F2EC\">99€</span> <span style=\"color:#6E7890\">(los 3 packs sueltos: 119,97€)</span>.",
